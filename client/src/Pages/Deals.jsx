...
export function Deals () {
  ...
  const handleFetch = async () => {
    await fetch('https://www.cheapshark.com/api/1.0/deals').then((response) => response.json())
      .then((data) => { setData(data); setLoading(false) }).catch((err) => console.log(err))
  }
        ...
        : (
          <div className='flex flex-col w-3/4'>
            <div className='flex items-center justify-start w-full mt-5'>
              <p className='text-[35px] font-bold'>Deals:</p>
